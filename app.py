...
async def database_connected():
    ...
    # await db.add_product("Samsung S23 Ultra", "Samsung Galaxy S23 Ultra Android smartphone. Announced Feb 2023. Features 6.8″ display, Snapdragon 8 Gen 2 chipset, 5000 mAh battery, 1024 GB storage", 12000000, "https://assets.asaxiy.uz/product/items/desktop/44f683a84163b3523afe57c2e008bc8c2022092114241486833ApwaRWowaz.png.webp", 5)
